...
setwd("C:/Projects/Coursera/Getting and Cleaning Data/Week 4/getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset")
...
## STEP 3: Extracts only the measurements on the mean and standard
